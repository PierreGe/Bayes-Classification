...
$P(Y=c | X=x)  = \frac{ \hat{p}_{c}(x) \hat{P}_{c}}{\hat{p}_{c'} \hat{P}_{c'} } $
...
Ce choix sera réalisé de manière empirique en testant plusieurs $seeds$ différents de manière a faire ressortir une "tendance général".
